...
export class ModalVerPersonalComponent implements OnInit {
  ...
  async printResguardoPatrimonio() {
    ...
    try {
      ...
      lineaDiagUint8 = await this.fetchImageAsUint8Array('/assets/images/lineaDiagonal.png');
    } catch (err) {
    ...
    const lineaDiagId = wb.addImage({ buffer: lineaDiagUint8, extension: 'png' });
    ...
    ws.addImage(lineaDiagId, `D${primerFilaVacia}:F48`);
